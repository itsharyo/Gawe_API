        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      child: Icon(Icons.school_outlined, // Ikon topi toga
              ...
              // 3. FORM INPUTS
              // University/School
              _buildFormLabel("University/School"),
              _buildTextField("University/School"),
              const SizedBox(height: 16),

              // Degree/Diploma
              _buildFormLabel("Degree/Diploma"),
              _buildTextField("Degree/Diploma"),
              const SizedBox(height: 16),
  ...
  Widget _buildSaveButton(Color colorPrimaryButton, Color colorUnguMuda) {
    return SizedBox(
      ...
      child: OutlinedButton(
        onPressed: () {
          print("Save Education History pressed");
        },
        child: const Padding(
