...
class PersonalStatementScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Kita kembalikan Container sebagai konten Bottom Sheet
    return Container(
      // Padding diatur di sini, bukan di Scaffold
            ...
            children: [
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      child: Icon(Icons.description, color: colorPurpleText, size: 40),
                    ),
              ...
              SizedBox(
                ...
                child: OutlinedButton(
                  onPressed: () {
                    print("Save Personal Statement pressed");
                  },
                  child: const Padding(
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    // Menggunakan pop untuk menutup Bottom Sheet
